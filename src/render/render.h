...
void renderPointCloud_SaveScreenshot(pcl::visualization::PCLVisualizer::Ptr& viewer, const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud, std::string name, Color color = Color(1, 1, 1), int id = 1);
